        ...
        <div className={`flex flex-col gap-2 ${className}`}>
            ...
            <div className="flex justify-center items-center gap-2">
                ...
                <button
                    ...
                    className="p-2 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-brand-primary/10 transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed flex items-center text-sm"
                    aria-label="First"
                >
                ...
                <button
                    ...
                    disabled={safeCurrentPage === 1}
                    className="p-2 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-brand-primary/10 transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                    aria-label="Previous"
                >
                        ...
                        <button
                            ...
                            className={`px-3 py-1 rounded-lg border transition cursor-pointer text-xs
                                ${pg === safeCurrentPage
                                    ...
                                    : 'bg-white text-gray-700 border-gray-300 hover:bg-brand-primary/10 text-xs'
                                }
                            `}
                        >
                            {pg}
