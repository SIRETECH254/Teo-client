...
// Cart success modal component shown after adding item to cart
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div className="relative bg-white rounded-t-lg shadow-xl w-full max-w-sm mx-4 mb-4 transform transition-all">
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">{itemName} has been added to your cart</p>
          ...
          <div className="flex gap-3">
            ...
            <button onClick={onGoToCart} className="flex-1 btn-primary">
              Go to Cart
            </button>
          </div>
        </div>
